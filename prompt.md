...
2026-03-21 | feat: DM 목록 탭 + 질문→DM 1:1 답변 + hooks 버그 수정 + 중복 import 정리
2026-03-21 | refactor: 코드 품질 — 중복 유틸 추출(8함수→2), React.memo(4곳), 의존성 업데이트
2026-03-21 | improve: 애니메이션 — voter exit, spring 참여율바, 마스코트 호흡, spring 프리셋(9곳)
2026-03-21 | fix: DM 실시간 + transition 완전(38곳) + tracking-tight(11곳) + 로그인 다크모드
