    ...
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
          <button onClick={() => setCount(Math.max(1, count - 1))} aria-label="추첨 인원 감소" className="px-2.5 py-2 text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
            <Minus size={14} />
          </button>
          <input
          ...
          />
          <button onClick={() => setCount(Math.min(eligibleParticipants.length, count + 1))} aria-label="추첨 인원 증가" className="px-2.5 py-2 text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors">
            <Plus size={14} />
          </button>
        </div>
