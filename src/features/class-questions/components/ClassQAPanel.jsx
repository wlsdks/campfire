          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700 shrink-0">
              <input
                ...
                className="flex-1 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-300 dark:placeholder:text-slate-500 focus:outline-none focus:border-orange-500 dark:focus:border-orange-500 focus:bg-white dark:focus:bg-slate-600 transition-all"
              />
              <button
                onClick={handlePost}
                disabled={!inputText.trim() || !canPost || posting}
                className="flex items-center justify-center w-10 h-10 rounded-xl bg-orange-600 dark:bg-orange-500 text-white disabled:opacity-30 hover:bg-orange-700 dark:hover:bg-orange-400 transition-colors shrink-0"
                aria-label="질문 보내기"
              >
                <Send size={16} />
              </button>
