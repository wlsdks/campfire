...
export default function ClassQABoard({ sessionId, showInput = true }) {
  const {
    questions, postQuestion, toggleUpvote, postAnswer, toggleAnswerUpvote, canPost,
        ...
        >
          <div className="flex gap-2">
            <input
              ...
              maxLength={200}
              className="flex-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-3 text-sm text-slate-900 dark:text-slate-100 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
            />
            <Button
