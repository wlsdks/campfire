...
export default memo(function ActivePollView({
  ...
  return (
    <div className={`min-h-dvh bg-slate-50 dark:bg-slate-900 flex flex-col items-center px-4 sm:px-5 pb-44 sm:pb-40 pt-20 overflow-y-auto ${question.type === 'imageSlide' ? 'justify-center' : ''}`}>
