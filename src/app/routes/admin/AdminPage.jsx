...
export default function AdminPage() {
  ...
  const isSpecialMode = ['roulette', 'lottery', 'prizeDraw', 'plinko', 'breakTime', 'leaderboard', 'teamBattle', 'qaBoard', 'awards', 'randomPicker', 'comprehension', 'quickSurvey', 'discussion', 'focus'].includes(currentMode);
