        ...
        <div>
          {speedQuizActive ? (
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-indigo-600 text-white text-sm font-medium transition-all active:scale-[0.97]"
            >
