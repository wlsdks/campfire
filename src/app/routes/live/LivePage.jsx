...
export default function LivePage() {
  ...
  return (
    <div className="h-dvh bg-slate-50 dark:bg-slate-900 flex flex-col overflow-hidden">
      ...
      <div className={`flex-1 flex justify-center overflow-auto px-8 pt-6 pb-16 ${isGameMode || (currentMode && ['poll','quiz'].includes(currentMode) && session?.currentQuestion) ? 'items-start' : 'items-center'}`}>
